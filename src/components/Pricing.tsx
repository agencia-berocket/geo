      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-zinc-200/60 pb-8 mb-16 gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs uppercase tracking-widest text-zinc-500">INVESTIMENTO TRANSPARENTE E PREVISÍVEL</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-24 md:mb-32">
          {pricingPlans.map((plan, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`tactile-raised p-8 md:p-10 flex flex-col justify-between relative overflow-hidden bg-white rounded-3xl transition-all duration-300 ${
                  isRecommended
                    ? 'border-2 border-red-500 shadow-[0_20px_40px_rgba(239,68,68,0.12)] scale-[1.02] z-10'
                    : isSelected
              ...
              >
                ...
                {/* Plan Header */}
                <div className={`space-y-6 ${isRecommended ? 'pt-4' : ''}`}>
                  ...
                  <div>
                    <h3 className="font-display font-black text-2xl md:text-3xl text-zinc-950 uppercase tracking-tight">
                      {plan.name}
                    </h3>
                  ...
                  <div className="pt-2 border-t border-zinc-100">
                    <div className="flex items-baseline gap-1.5">
                      <span className="font-display font-black text-4xl lg:text-5xl text-zinc-950 tracking-tighter">
                        {plan.price}
                      </span>
                      {plan.billing && (
                  ...
                  <div className="space-y-3.5 pt-4 border-t border-zinc-100">
                    ...
                    {plan.bullets.map((bullet, bulletIdx) => (
                      <div key={bulletIdx} className="flex items-start gap-3 text-xs md:text-[13px] text-zinc-600">
                ...
                <div className="pt-8 mt-6 border-t border-zinc-100">
                  <button 
                    ...
                    className={`w-full font-mono text-xs font-bold py-4 px-6 tracking-widest uppercase transition-all duration-300 flex items-center justify-center gap-2 rounded-xl cursor-pointer shadow-md ${
                      isRecommended
        ...
        <div id="formulario-agendamento" className="bg-white border border-zinc-200 rounded-3xl p-8 md:p-12 shadow-sm relative overflow-hidden">
          <div className="max-w-3xl space-y-4">
            ...
            <h3 className="font-display font-extrabold text-2xl md:text-3xl text-zinc-950 uppercase tracking-tight">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3.5 font-mono text-xs text-zinc-950 placeholder-zinc-400 focus:outline-none focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 shadow-inner"
                />
                <input
                  type="email"
                  required
              ...
              <button
                type="submit"
                className="w-full md:w-auto bg-zinc-950 hover:bg-zinc-800 text-white font-mono text-xs font-bold px-8 py-4 uppercase tracking-widest transition-all rounded-xl cursor-pointer shadow-md border-t border-zinc-700 flex items-center justify-center gap-2"
              >
                SOLICITAR AGENDAMENTO IMEDIATO ➔
              </button>
            </form>

            <div className="pt-2 text-[10px] text-zinc-400 font-sans font-light flex items-center gap-1.5">
