...
export default function GoogleSearchMode() {
  ...
  return (
    <section id="google-mode" className="bg-[#f4f5f8] grid-blueprint py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 border-b border-zinc-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-5 sm:space-y-6">
            ...
            <h2 className="font-display font-extrabold text-2xl sm:text-3xl md:text-4xl text-zinc-950 tracking-tight leading-[1.08] uppercase">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="tactile-raised rounded-2xl sm:rounded-[2rem] bg-white border border-zinc-200 overflow-hidden shadow-[0_15px_50px_rgba(0,0,0,0.03)] flex flex-col relative z-0">
              ...
              <div className="bg-zinc-50 border-b border-zinc-200/80 px-3.5 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                ...
                <div className="font-mono text-[7.5px] sm:text-[9px] text-zinc-400 font-bold uppercase tracking-widest">
                  google_simulator_v2.0
                </div>
                <div className="flex items-center gap-1 text-[7.5px] sm:text-[10px] font-mono text-zinc-400">
                  <Radio className="w-2.5 sm:w-3 h-2.5 sm:h-3 text-emerald-500 animate-pulse" />
              ...
              <div className="p-3.5 sm:p-6 md:p-8 border-b border-zinc-200/60 bg-white">
                <div className="relative w-full">
                  <div className="absolute top-1/2 -translate-y-1/2 left-3 sm:left-4 flex items-center pointer-events-none">
                    <Search className="h-3.5 w-3.5 text-zinc-400" />
                  </div>
                  <div className="w-full pl-8 sm:pl-11 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-zinc-50 border border-zinc-250 rounded-xl sm:rounded-2xl text-zinc-800 text-[10px] sm:text-xs md:text-sm font-medium shadow-inner min-h-[44px] flex items-center whitespace-normal break-words leading-snug">
                    {searchQuery}
                  </div>
                </div>

                {/* The Mode Switcher Selector Buttons */}
                <div className="flex items-stretch sm:items-center justify-center gap-2 sm:gap-3 mt-3 sm:mt-5">
                  <button
                    onClick={() => setActiveMode('seo')}
                    className={`flex items-center justify-center gap-1.5 sm:gap-2 flex-1 sm:flex-initial px-3 sm:px-4 py-2.5 min-h-[44px] rounded-xl border font-mono text-[9.5px] sm:text-[10px] font-extrabold uppercase tracking-wider cursor-pointer transition-all duration-300 ${
                      activeMode === 'seo'
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-1.5 sm:gap-2 flex-1 sm:flex-initial px-3 sm:px-4 py-2.5 min-h-[44px] rounded-xl border font-mono text-[9.5px] sm:text-[10px] font-extrabold uppercase tracking-wider cursor-pointer transition-all duration-300 relative ${
                      activeMode === 'geo'
