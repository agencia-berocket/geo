...
export function IconClients({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconRocket({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M12 15c3.16 0 5.85-1.36 7.6-3.68A15.9 15.9 0 0 0 22 4a15.86 15.86 0 0 0-7.32 2.4C12.36 8.15 11 10.84 11 14c0 .5 0 1 .17 1z" />
      <path d="M9 12c-1.05-.83-3-.4-4.5.5C3.5 13.5 2 17 2 17s3.5-1.5 4.5-3c.9-1.5 1.33-3.45.5-4.5z" />
...
export function IconHourglass({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M5 22h14M5 2h14M17 22v-4.17a2 2 0 0 0-.59-1.42L12 12l-4.41 4.41A2 2 0 0 0 7 17.83V22M7 2v4.17a2 2 0 0 0 .59 1.41L12 12l4.41-4.42A2 2 0 0 0 17 6.17V2" />
    </svg>
  );
}
...
export function IconNote({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M17 3v3h3M8 12h8M8 16h5" />
    </svg>
  );
}
...
export function IconChevron({ className = base, direction = 'down' }: IconProps & { direction?: 'up' | 'down' | 'left' | 'right' }) {
  const rotation = { up: 'rotate-180', down: '', left: 'rotate-90', right: '-rotate-90' }[direction];
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={`${className} ${rotation}`}>
      <path d="m6 9 6 6 6-6" />
    </svg>
  );
}
...
export function IconSparkles({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M5 3 4 6 1 7l3 1 1 3 1-3 3-1-3-1L5 3z" />
    </svg>
  );
}
